    ...
    <div className="App">
      <Router>
        <header>
          ...
          <Container>
            {/*  In this case, we define the variant of this navbar to have a tab design. The fill property allows for Nav items being evenly spaced. */}
            <Nav defaultActiveKey="/" variant="tabs" fill>
              ...
              <Nav.Item>
                <Nav.Link eventKey={"packagesPage"}>
                  <Link to="/packages">Our Packages</Link></Nav.Link>
              </Nav.Item>
            </Nav>
          </Container>
        </header>
